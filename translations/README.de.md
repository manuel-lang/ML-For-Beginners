...
# Machine Learning für Anfänger*innen - Ein Lehrplan

> 🌍 Reise um die Welt und erforsche maschinelles Lernen anhand von Kulturen aller Welt 🌍

Die Azure Cloud Advocates bei Microsoft freuen sich, einen 12-wöchigen Kurs mit 24 Lektionen (plus eine!) rund um das Thema **Maschinelles Lernen** anbieten zu können. In diesem Kurs lernt ihr das, was manchmal als **klassisches maschinelles Lernen** bezeichnet wird, wobei in erster Linie Scikit-learn als Bibliothek verwendet und Deep Learning vermieden wird, das in unserem demnächst erscheinenden Kurs "KI für Anfänger*innen" behandelt wird. Kombinieren Sie diese Lektionen auch mit unserem ['Data Science für Anfänger*innen' Lehrplan] (https://aka.ms/datascience-beginners)!

Reise mit uns um die Welt, während wir diese klassischen Methoden auf Daten aus verschiedenen Regionen der Welt anwenden. Zu jeder Lektion gehören Quizfragen vor und nach der Lektion, schriftliche Anweisungen zur Durchführung der Lektion, eine Lösung, eine Aufgabe und vieles mehr. Unser projektbasierter Lehrstil ermöglicht es dir zu lernen, während du etwas aufbaust - eine bewährte Methode, um neue Kenntnisse zu behalten.

**✍️ Herzlichen Dank an unsere Autor*innen** Jen Looper, Stephen Howell, Francesca Lazzeri, Tomomi Imura, Cassie Breviu, Dmitry Soshnikov, Chris Noring, Ornella Altunyan, und Amy Boyd

**🎨 Dank auch an unsere Grafiker*innen** Tomomi Imura, Dasani Madipalli, und Jen Looper

**🙏 Besonderer Dank 🙏 an unsere Microsoft Student Ambassador-Autor*innen, Reviewer und Mitwirkenden**, insbesondere Rishit Dagli, Muhammad Sakib Khan Inan, Rohan Raj, Alexandru Petrescu, Abhishek Jaiswal, Nawrin Tabassum, Ioan Samuila und Snigdha Agarwal

**🤩 Ein besonderer Dank geht an den Microsoft Student Ambassador Eric Wanjau für unsere R-Kurse!** 
